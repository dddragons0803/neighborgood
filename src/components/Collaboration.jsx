...
import belowneighbour from '../assets/services/belowneighbour.webp'
    ...
    <Section crosses>
      <div className="container lg:flex">
        <div className="max-w-[30rem]">
          ...
          A Way For Neighbors to Connect
          </h2>
        ...
        <div className="lg:ml-auto xl:w-[44rem] mt-4">
